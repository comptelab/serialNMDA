...
def run_simulation(i):
    ...
    beh_log     = "read_out_log_beh_Apre%.5f_rep%.2f.txt" %(par, repstrength)
    fr_log      = "read_out_log_fr_Apre%.5f_rep%.2f.txt" %(par, repstrength)
    stp_log     = "read_out_log_stp_Apre%.5f_rep%.2f.txt" %(par, repstrength)
